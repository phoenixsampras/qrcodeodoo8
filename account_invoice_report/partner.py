...
class res_partner(orm.Model):
    ...
    _columns = {
        ...
        'nit': fields.char('NIT Code Customer', size=11, help=u"Número de Identificación Tributaria (o CI para facturación)."),
        ...
        'legal_name_customer': fields.char('Legal Name Customer', size=32)
    }
    ...
    def _check_unique_val(self, cr, uid, ids, context=None):
        ...
        for partner in self.read(cr, uid, ids, ['nit', 'ci', 'id'], context=context):
